      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600">
            Our advanced AI doesn't just count calories—it analyzes ingredients, predicts glucose impact, and provides actionable recommendations tailored to your unique metabolic profile. The more you use NutriSnap, the smarter it gets about your body's specific responses.
          </p>
        </div>
